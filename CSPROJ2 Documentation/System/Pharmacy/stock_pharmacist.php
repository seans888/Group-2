...
<hr/>	
    <div class="tabbed_area">  
        ...
        <ul class="tabs">  
            ...
            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">Add Medical Supplies</a></li>  
		...
		*/
        ...
        echo "<table border='1' cellpadding='3'>";
         echo "<tr><th>ID</th><th>Item Name</th><th>Type</th><th>Description</th><th>Status </th><th>Date </th><th>Delete</th></tr>";
        ...
        <div id="content_2" class="content">  
		 ...
		 <?php echo $message;
			...
			<table width="420" height="106" border="0" >	
				<tr><td align="center"><input name="drug_name" type="text" style="width:170px" placeholder="Medicine/Supplies" required="required" id="drug_name" /></td></tr>
				<tr><td align="center"><input name="category" type="text" style="width:170px" placeholder="Type" required="required" id="category"/></td></tr>
