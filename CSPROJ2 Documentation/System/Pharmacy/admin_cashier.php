...
<h5>Cruz-Rabe Maternity & General Hospital | SSMC-F-PHR-001-R.0</h5></div>
<div id="left_column">
<div id="button">
<ul>
    ...
    <div class="tabbed_area">  
		...
		*/
        ...
        while($row = mysql_fetch_array( $result )) {
				...
				?>
				<td><a href="update_cashier.php?username=<?php echo $row['username']?>"><img src="images/update.jpg" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_cashier.php?cashier_id=<?php echo $row['cashier_id']?>"><img src="images/delete.jpg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
