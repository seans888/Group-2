    ...
    <div class="tabbed_area">  
       ...
       $result = mysql_query("SELECT * FROM pharmacist")or die(mysql_error());
        ...
        while($row = mysql_fetch_array( $result )) {
				...
				?>
				<td><a href="update_pharmacist.php?username=<?php echo $row['username']?>"><img src="images/update.jpg" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_pharmacist.php?pharmacist_id=<?php echo $row['pharmacist_id']?>"><img src="images/delete.jpg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
