...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/hd_logo.jpg"></a>Cruz-Rabe Pharmacy System©</h1>
<h5>Cruz-Rabe Maternity & General Hospital | SSMC-F-PHR-001-R.0</h5>
</div>
<div id="left_column">
<div id="button">
<ul>
			<li><a href="pharmacist.php">Main Page</a></li>
			<li><a href="prescription.php">Prescription Request</a></li>
			<li><a href="stock_pharmacist.php">Stock Inventory</a></li>
...
<hr/>	
    <div class="tabbed_area">  
       ...
       $result = mysql_query("SELECT * FROM prescription")or die(mysql_error());
        ...
        echo "<tr> <th>Patient Name</th><th>Prescription No.</th> <th>Official Receipt No.</th><th>Date </th><th>Delete</th></tr>";
			...
			$(document).ready(function()
	{
		...
		<form name="myform" onsubmit="return validateForm(this);" action="invoice.php" method="post" >
			<table width="200" height="106" border="0" >	
				<tr><td align="left"><input name="customer_name" placeholder="Patient No" id="customer_id"type="text" style="width:170px" required="required" /></td></tr>
				<tr><td align="left"><input name="customer_name" placeholder="Patient Name" id="customer_name"type="text" style="width:170px" required="required" /></td></tr>
				...
				echo"<select  class=\"input-small\" name=\"drug_name\" style=\"width:170px\" id=\"drug_name\">";
						 ...
						 echo"<option>Select Medicine/Supplies</option>";
		...
		echo"</select>";?>  </td></tr>
<tr><td align="left"><input name="strength" type="text" style="width:170px"  id="strength"placeholder="Strength mg* ml* " /></td></tr>
				<tr><td align="left"><input name="dose" type="text" style="width:170px" id="dose" placeholder="Dosage **x/day" /></td></tr>
...
<div id="footer" align="Center">Asia Pacific College© | Developer: Bueno - Rosales</div>
</div>
</body>
</html>
