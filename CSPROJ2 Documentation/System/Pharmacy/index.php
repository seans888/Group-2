...
<div id="content">
<div id="header">
<h1><img src="images/hd_logo.jpg">Cruz-Rabe Pharmacy System©</h1>
</div>
<div id="main">
  ...
  <section class="container">
	 ...
	 <img src="images/DOH.jpg">
      ...
      <form method="post" action="index.php">
		...
		<p><select name="position" style="margin-left: 32;">
        ...
        <p class="submit"><input type="submit" name="submit" value="Log In"></p>
      </form>
    </div>
    </section>
</div>
